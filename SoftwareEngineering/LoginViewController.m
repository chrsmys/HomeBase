...
- (IBAction)LoginButtonPressed:(id)sender {
    if([[EDJAccountManager sharedInstance] createUser:@"Dave" pass:@"dave" dbUsername:@"cmays2" dbPassword:@"Phonedev1" connectionString:@"//137.45.192.130/itec2.radford.edu"]){
