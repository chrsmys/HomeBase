...
-(void)addColumnWithName:(NSString *)columnName type:(NSString *)type size:(int)size notNull:(BOOL)notNull unique:(BOOL)unique{
    ...
    NSMutableDictionary *column = [NSMutableDictionary dictionaryWithDictionary:@{@"name" : columnName, @"type" : type, @"notNull" : [NSNumber numberWithBool:notNull], @"unique" : [NSNumber numberWithBool:unique]}];
    if(size>0){
...
-(void)addPrimaryKeyWithConstraintName:(NSString *)constraintName withColumns:(NSArray *)columns{
    NSMutableDictionary *primaryKeyDictionary = [NSMutableDictionary dictionaryWithDictionary:@{@"constraintName" : constraintName, @"cols" : columns}];
...
-(void)addForiegnKeyWithConstraintName:(NSString *)constraintName tableColumn:(NSString *)tColumn refTable:(NSString *)referencingTable refCol:(NSString *)referencingColumn deferable:(BOOL)deferable{
    NSDictionary *foriegnDictionary = @{@"constraintName" : constraintName, @"tableCol" : tColumn, @"refTable" : referencingTable, @"refCol": referencingColumn, @"deferrable" : [NSNumber numberWithBool:deferable]};
